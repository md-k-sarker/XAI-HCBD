...
public class Testing {
	...
	public static void doAlignMent() throws Exception {
		...
		OWLOntology ontA = Explanation.loadOntology(new File("/home/sarker/Desktop/test/sumo_without_indi.owl"));
		String saveTo = "/home/sarker/Desktop/test/_aligned__.owl";

		IRI ontoIRI = IRI.create(Constants.prefix);
